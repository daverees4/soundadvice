        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-4 wow fadeInLeft" data-wow-offset="10" data-wow-duration="1.75s">
                    <div class="single-service border-bottom-hover">
                        <div class="service-icon colored-text">
                            <span class="icon-cloud-upload-alt"></span>
                        </div>
                ...
                <div class="col-md-4 wow fadeInRight" data-wow-offset="10" data-wow-duration="1.75s">
                    <div class="single-service border-bottom-hover">
                        <div class="service-icon colored-text">
                            <span class="icon-music-microphone-old"></span>
                        </div>
...
<div class="container">
  ...
  <option value="1" id="14.99">Audition Package (1 recording, 100 words of feedback)</option>
  <option value="2" id="39.99">Bootcamp Package (3 recordings, 300 words of feedback)</option>
  <option value="3" id="99.99">Finalist Package (One-to-one session)</option>
